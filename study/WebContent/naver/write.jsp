...
<script type="text/javascript">
	...
	f.action = "<%=cp%>/naver/write_ok.jsp";
	f.submit();
	...
	function hello2() {
		...
		if((ch.doublecheckid.value)!="" && (ch.doublecheckid.value)!=((ch.pw.value))){
	...
	function hello3() {
		...
		if ((ch.doublecheckid.value)!=(ch.pw.value)){
			ch.red3.value="비밀번호가 일치하지 않습니다";
...
<tr>
<td>이름<br/>
<input type="text" name="name" style="height:45px" onblur="hello4();" size="61" name="pw"/><br/>
